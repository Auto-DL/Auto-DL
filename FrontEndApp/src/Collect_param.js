            ...
            <div className={
                ...
                Object.keys(this.props.layer_selected).length === 0 ? (
                    ...
                    <div> {
                        ...
                        Object.keys(this.props.layer_selected).map(key => (
                            <div className={
                                classes.batch
                            }>
                                <div> {key}
                                ...
                                this.props.layer_selected[key]["Datatype"] == 'select' ? (
                                    <div>
                                        ...
                                        <FormControl variant="outlined" size="small">
                                            ...
                                            <Select native
                                                value={
                                                    this.props.layer_selected[key]["Default"]
                                                }
                                                // onChange={handleChange}
                                                onChange={
                                                    this.props.changed_value(key)
                                                }
                                                label={key}
                                                // inputthis.props={{
                                                // name: 'age',
                                            ...
                                            >
                                                {
                                                this.props.layer_selected[key]["Options"].map(arr => (
                                                    <option value={arr}>
                                                        {arr}</option>
                                                ))
                                            } </Select>
                                    ...
                                    <div>
                                        <TextField required size="small" id="outlined-required" label="Required"
                                            ...
                                            helperText={
                                                `Example - ${
                                                    this.props.layer_selected[key]["Example"]
                                                }`
                                            }/>
                                    </div>
                                )
