...
export default function Donate() {
  ...
  return (
    <div>
      ...
      <Modal onClose={() => setSuccessModalOpen(false)} open={successModalOpen}>
        ...
        <Box className={classes.modalBox}>
          ...
          <div className={classes.amountContainer}>
            ...
            <TextField
              ...
              variant="outlined"
              placeholder="Other"
              onChange={(e) => handleDonateAmount(Number(e.target.value))}
              InputProps={{
          ...
          <div className={classes.actionBtnContainer}>
            <Button onClick={() => modalClose()} className={classes.actionBtn} color="primary" variant="outlined">
              Go Back
            </Button>
            <Button
